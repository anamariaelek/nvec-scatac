...
motifs_dapseq <- sapply(
  dapseq_dt$sample,
  function(x) {
    m_name <- dapseq_dt[sample == x]$gene_name
...
length(unique(assign_dt$gene)) # 552
...
tfam_dt <- arc_plt_dt[, .(archetype_name, archetype_family)]
