...
dt1 <- fread(file.path("results", "Archetypes", "motif-assignment-archetypes-PPM-PCC-0.8-IC0.5-5bp.tsv.gz"))
...
dt2 <- fread(file.path("results", "Archetypes", "motif-assignment-plus-cisbp-archetypes-PPM-PCC-0.8-IC0.5-5bp.tsv.gz"))
