...
- directly determined motifs from CiSBP... well, upon inspection, we determined these PBM motifs are not so good so we will not overwrite the assignments with them
