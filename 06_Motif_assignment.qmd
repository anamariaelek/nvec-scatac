...
#| label: cisbp_direct_motifs
 ...
 # TF and motif info
cisbp_dt <- fread(file.path(cisbp_dir, "cisbp_nvec_motifs.tsv"))
cisbp_dt <- cisbp_dt[TF_Status == "D" & Motif_Species == "Nematostella_vectensis" & TF_Name != ""]
...
```{r}
motifs <- c(motifs_cisbp, motifs_dapseq)
...
genes <- c(genes_cisbp, genes_dapseq)
