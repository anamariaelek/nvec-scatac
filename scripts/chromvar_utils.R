# https://raw.githubusercontent.com/rargelaguet/mouse_organogenesis_10x_multiome_publication/main/atac/archR/chromvar/utils.R
...
.customDeviationsSingle <- function(
  ...
  outList <- tryCatch({
    ...
    ################################
    #countsMatrix <- countsMatrix[rownames(annotationsVector), ]
    #expectation <- expectation[rownames(annotationsVector)]
